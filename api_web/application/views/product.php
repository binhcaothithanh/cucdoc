    ...
    <actinic:section>
                        ...
                        <tr>
                            <td class="mzp-img-below product_album">
                                <a rel="prettyPhoto" href="<?php echo $folder . 'goc/' . @$list_image[0]['name']; ?>">
                                    <img src="<?php echo $folder . 'goc/' . @$list_image[0]['name']; ?>"  border="0" width="280" height="280"  alt="<?php echo $product['title']; ?>" style="opacity: 1;">
                                </a>
        ...
        <div class="product-details-text">
            <actinic:prices  retail_price_prompt="Price:">
                <div id="id1264StaticPrice" style="display: inline">
            ...
            <div class="tab-area">
                <ul class="tabs" id="custom-tabs">
                    <li><a href="javascript:void(0)" rel="tab2" class="">Đánh giá</a></li>
                </ul>
                <div class="tab-contents-here">
                    <div class="tabcontent" id="tab1">
                        <div class="facebook-comments hidden-xs">
        ...
        <div class="product-promo-list">
            <?php foreach ($other_products as $item): ?>
                <div class="tas-product-promo">
                    <div class="product-corner"></div>
                    <div class="tas-product-promo-image">
