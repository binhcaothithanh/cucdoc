                    ...
                    <div class="box box-primary box-success">                       
                        <div class="box-body">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control format_number"  value="<?php echo $product['cogs']; ?>" name="cogs">
                            </div> 
                            <div class="form-group">
                            ...
                            <p>
                                ...
                                <img width="20px" src="<?php echo '/assets/upload/product/' . $product['folder'] . '/' . $product['image']; ?>"/>
                                ...
                                <div class="image_product_details">
                                    <?php if (!empty($images)): ?>
                                        <?php foreach ($images as $item): ?>                       
                                            <div class="row">
                                                <img  width="20px"  src="<?php echo "/assets/upload/product/{$product['folder']}/goc/{$item['name']}"; ?>"/>                                                                     
                            ...
                            <div class="box-body">
                                <div class="form-group">
                                    ...
                                    <select class="form-control" name="can_buy">
                                        ...
                                        <option <?php echo $product['can_buy'] == 1 ? 'selected' : ''; ?> value="1">YES</option>                                        
                                    </select>
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control" name="product_status">
                                        ...
                                        <option <?php echo $product['product_status'] == 1 ? 'selected' : ''; ?> value="1">Bán chạy</option>
                                        <option <?php echo $product['product_status'] == 2 ? 'selected' : ''; ?> value="2">Sẩn phẩm mới</option>
                                    </select>
                                </div> 
                                <br/>
                                <div class="form-group">
                                                ...
                                                <?php if ($first_color != $item['color']): ?>
                                                    ...
                                                    <tr color="<?php echo $item['color']; ?>">
                                                        ...
                                                        <td colspan="2">
                                                            ...
                                                            <img width="20px"  src="/assets/upload/product/<?php echo $product['folder'] . '/' . $item['image']; ?>"/>
                                                        </td>
                                                    </tr>
                                                <?php endif; ?>

                                                <tr id="<?php echo $item['id']; ?>" color="<?php echo $item['color']; ?>" rel="<?php echo $item['color'] . '|' . $item['size']; ?>">
                                                    <td><?php echo $item['size']; ?><input class="format_number count" name="count_update[]" value="<?php echo $item['count']; ?>"/></td>
                                                    <td><input type="hidden" name="ids_update[]" value="<?php echo $item['id']; ?>"/><a class="del_attr" href="javscript:void(0)">Xoá</a></td>
                                                </tr>
                                            <?php endforeach; ?>
                                        <?php endif; ?>
                                    </tbody>
